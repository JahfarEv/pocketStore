...
//                 className="group relative w-full sm:w-auto px-5 sm:px-6 py-4 bg-gradient-to-r from-blue-500 via-purple-500 to-purple-600 rounded-xl shadow-4xl cursor-pointer hover:shadow-purple-500/30 hover:shadow-3xl transition-all duration-400 transform hover:scale-[1.03] min-w-[300px] border border-white/20"
//               >
//                 <div className="absolute -inset-2 bg-gradient-to-r from-cyan-400 via-blue-800 to-green-600 rounded-xl blur-xl opacity-40 group-hover:opacity-70 transition-all duration-500"></div>

//                 <div className="absolute -inset-0.5 bg-gradient-to-r from-blue-400 to-green-500  rounded-xl opacity-0 group-hover:opacity-100 animate-pulse transition-opacity duration-500"></div>
...
//                       <span className="bg-gradient-to-r from-white to-gray-200 bg-clip-text text-transparent text-xl">
//                         We Build. You Grow{" "}
//                       </span>
//                     </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          ...
          <div>
            ...
            {/* Primary CTA Buttons - Both on same line */}
            <div className="flex flex-col sm:flex-row space-y-4 sm:space-y-0 sm:space-x-4 mb-6">
              <a
                href="https://play.google.com/store/apps/details?id=com.poketstor.platform&pcampaignid=web_share"
                target="_blank"
              ...
              {/* Career Button - Now on same line as Play Store button */}
              <button
                onClick={() => navigateTo("careers")}
                className="bg-gradient-to-r from-green-500 to-emerald-600 hover:from-green-600 hover:to-emerald-700 text-white font-semibold px-6 py-4 rounded-lg shadow-lg transition flex items-center justify-center"
              >
                <FaUsers className="text-xl mr-3" />
                <div className="flex flex-col items-start">
            ...
            {/* Services Link - Only if needed, but removed from here as career is now above */}
            <div className="pt-2">
